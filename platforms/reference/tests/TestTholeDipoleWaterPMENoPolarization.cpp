...
/**
 * This tests TholeDipoleForce water PME with NO polarization (zero polarizabilities)
...
void testTholeDipoleWaterPMENoPolarization() {
    ...
    // Add particles with ZERO polarizability
    for (unsigned int jj = 0; jj < numberOfParticles; jj += 3) {
    ...
    // Get TholeDipole energy and forces
    ...
    cout << "TholeDipole standalone energy: " << tholeEnergy << " kJ/mol" << endl;
...
int main(int argc, char* argv[]) {
    try {
        ...
        testTholeDipoleWaterPMENoPolarization();
    }
