...
void testZOnlyNoDip() {
    ...
    // Zero dipoles for both particles
    ...
    // With no dipoles, this is just charge-charge + induced dipole interactions
    // Forces should be purely along Z (no x,y components) due to symmetry
